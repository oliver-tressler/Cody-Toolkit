...
{
    public class OptionSetSetterPropertyGenerator : DefaultSetterPropertyGenerator
    {
        public OptionSetSetterPropertyGenerator(OptionSetAttributeData attributeData, EntityData entity) : base(
